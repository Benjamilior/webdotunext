...
export function SignupFormDemo() {
  ...
  return (
    <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 w-full mx-auto my-20">

      <div className="flex-1 w-1/2 bg-black">

      </div>

    <div className=" flex-1   rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-white dark:bg-black">
