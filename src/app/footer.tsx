    ...
    return (
        ...
        <div className="mt-[100px] mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
              ...
              <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                  <div>
                      ...
                      <ul className="text-white font-medium">
                          <li className="mb-4">
                              <a href="https://flowbite.com/" className="hover:underline">Noticias</a>
                          </li>
                          <li>
                  ...
                  <div>
                      <h2 className="mb-6 text-sm font-semibold text-white uppercase dark:text-white">Contáctanos</h2>
                      <ul className="text-white dark:text-gray-400 font-medium">
                          <li className="mb-4">
                              <a href="https://github.com/themesberg/flowbite" className="hover:underline ">+569 7857 2655</a>
                          </li>
                          <li className="mb-4">
                              <a href="https://github.com/themesberg/flowbite" className="hover:underline ">bmunoz@dotu.tech</a>
                          </li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
              <span className="text-sm text-white sm:text-center dark:text-gray-400">© 2024 <a href="https://flowbite.com/" className="hover:underline">dotu</a>. Todos los derechos reservados.
              </span>
              <div className="flex mt-4 sm:justify-center sm:mt-0">
    
                <div className="flex justify-center items-center space-x-6 p-6 rounded-lg shadow-lg">
                <Instagram className="w-8 h-8 text-white hover:text-purple-200 transition-colors duration-200 cursor-pointer" />
                <Linkedin className="w-8 h-8 text-white hover:text-purple-200 transition-colors duration-200 cursor-pointer" />
                <Mail className="w-8 h-8 text-white hover:text-purple-200 transition-colors duration-200 cursor-pointer" />
                </div>
