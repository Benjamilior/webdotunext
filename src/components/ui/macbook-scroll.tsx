...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[150vh]  flex flex-col items-center py-0 md:py-20 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.30] sm:scale-50"
    >
      <motion.h2
        style={{
